...
# latex
sudo apt-get install -y texlive-latex-base texlive-latex-extra texlive-science texlive-latex-recommended texlive-bibtex-extra texlive-fonts-extra cm-super latexmk biber
